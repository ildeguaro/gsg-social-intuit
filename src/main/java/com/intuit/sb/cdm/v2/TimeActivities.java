    ...
    implements Serializable
{
    ...
    protected List<TimeActivity> timeActivities;

    /**
     * Gets the value of the timeActivities property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the timeActivities property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTimeActivities().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<TimeActivity> getTimeActivities() {
        if (timeActivities == null) {
            timeActivities = new ArrayList<TimeActivity>();
        }
