...
@XmlRootElement(name = "CreditCardCredit")
    ...
    implements Serializable
{
    ...
    protected List<CreditCardCreditLine> lines;
     ...
     * 
     */
    public List<CreditCardCreditLine> getLines() {
        if (lines == null) {
            lines = new ArrayList<CreditCardCreditLine>();
        }
        return this.lines;
    }
