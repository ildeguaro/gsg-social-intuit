    ...
    implements Serializable
{
    ...
    protected List<InventoryAdjustment> inventoryAdjustments;

    /**
     * Gets the value of the inventoryAdjustments property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the inventoryAdjustments property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInventoryAdjustments().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InventoryAdjustment> getInventoryAdjustments() {
        if (inventoryAdjustments == null) {
            inventoryAdjustments = new ArrayList<InventoryAdjustment>();
        }
